...
final guestProfilePic =
    "https://firebasestorage.googleapis.com/v0/b/tic-tac-toe-a5183.appspot.com/o/icons8-user-male-100.png?alt=media&token=a6cc0ac2-05a6-44ba-bbff-d4775e5db27a";
...
final String packageName = 'com.sahulat.tictactoe';
final String androidLink =
    'https://play.google.com/store/apps/details?id=$packageName';

//-- Add IOS application package & link here (if published on App Store)
final String iosPackage = 'com.sahulat.tictactoe';
